...
/**
   ...
   */
  Keystore.deriveKey = function (password, salt, options, cb) {
    var prf, self = this;
 ...
 * @return {Object}
 */
Keystore.dump = function (password, privateKey, salt, iv, options, cb) {
    options = options || {};
    iv = this.str2buf(iv);
...
var s = k.newKeystore(keyBuffer, params);
console.log(s)

var d = k.dump("123", keyBuffer, s.salt, s.iv, options)
console.log(d)